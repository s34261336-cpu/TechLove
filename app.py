...
MODELS = {
    ...
    "or_nemotron_ultra": {
        ...
        "provider": "openrouter",
        "description": "NVIDIA Nemotron Ultra — 550B параметров. Один из самых мощных бесплатных.",
        "emoji": "🚀",
    ...
    "or_nemotron_super": {
        ...
        "provider": "openrouter",
        "description": "NVIDIA Nemotron Super — 120B. Быстрее Ultra, отличное качество бесплатно.",
        "emoji": "⚡",
    ...
    "or_gpt_oss": {
        ...
        "provider": "openrouter",
        "description": "Open-source модель от OpenAI, 20B. Бесплатно через OpenRouter.",
        "emoji": "🤍",
