...
MODELS = {
    ...
    "or_ling_flash": {
        ...
        "provider": "openrouter",
        "description": "Молниеносная модель от InclusionAI. Самая быстрая в списке — мгновенные ответы.",
        "emoji": "⚡",
    ...
    "or_laguna_xs": {
        ...
        "provider": "openrouter",
        "description": "Компактная модель от Poolside. Быстрая и чёткая — хорошо справляется с кодом и задачами.",
        "emoji": "🌊",
        "emoji_html": pe("5388957777676745182", "🌊"),
        "emoji_id": "5388957777676745182",
    },
    "or_nemotron_omni": {
        ...
        "provider": "openrouter",
        "description": "NVIDIA Nemotron Nano с режимом рассуждений. Умная и бесплатная.",
        "emoji": "🚀",
    ...
    "or_cohere_mini": {
        ...
        "provider": "openrouter",
        "description": "Мини-модель от Cohere с упором на код. Точная и стабильная.",
        "emoji": "🔷",
        "emoji_html": pe("5776233299424843260", "🔷"),
        "emoji_id": "5776233299424843260",
    },
...
MODEL_STYLES = {
    ...
    "or_laguna_xs": "success",
    "or_nemotron_omni": "danger",
    "or_cohere_mini": "primary",
}
